# Generated by Powerlevel10k configuration wizard on 2026-03-26 at 08:25 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_SHOW_DEFAULT=false
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_SHOW_ON_COMMAND='terraform|tf|tfenv'
